...
function setDocumentListeners() {
    ...
    // exact drop coordinates taken from placeholder (shallow clone)
    ...
    // apply to grid
    currentWin.style.gridColumn = `${col} / span ${currentWin.dataset.columns}`;
    currentWin.style.gridRow    = `${row} / span ${currentWin.dataset.rows}`;

    // reset absolute positioning
    currentWin.classList.remove('gridChild-grabbed');
    currentWin.style.position = "";
