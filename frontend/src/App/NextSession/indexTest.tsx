            ...
            <div id="countdownBannerContainer" className="border flex flex-col gap-0">
                ...
                <div id="timingContainers" className="pl-4 pr-4 pb-4 pt-2 flex flex-col">
                    ...
                    <div id="countdownAndLocal" className="border-b pb-4 flex justify-center">
                        <div id="countdownContainer" className="border-r pr-4 gap-4 flex flex-row text-2xl font-bold truncate">
                    ...
                    <div>
                        {/* <div>Coming up</div> */}
                        <div id="otherCountdowns" className="pt-4 pb-4 overflow-x-auto flex gap-10 max-w-full "></div>
                    </div>
